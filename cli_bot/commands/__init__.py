...
__all__ = ['add_contact', 'change_contact','show_phone', 'show_all', 'parse_input' , 'input_error', 'AddressBook', 'Record', 
        'add_birthday','show_birthday', 'birthdays','add_address','add_email','delete_contact','find_by_email','find_by_name', 'save_data','load_data', 'NoteBook', 'add_note', 'find_note','show_notes','edit_note','delete_note', 'help_text']
